...
mod inner {
    ...
    pub async fn run_query(query: &str) -> CascadeResult {
        ...
        let result = tokio::task::spawn_blocking(move || super::super::shell::execute(&cmd))
    ...
    pub fn check_status() -> Status {
        let ok = super::super::shell::execute("test -f /home/arjun/fuche-coder/cascade.py && echo 'ok'")
